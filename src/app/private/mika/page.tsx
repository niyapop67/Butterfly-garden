 ...
 * desktop, filling the full viewport there (cover-fit, no letterboxing —
 * briefly tried matching the Garden page's contain-fit technique instead,
 * but confirmed the original ask was a true edge-to-edge fill).
 *
...
export default function MikaLandingPage() {
  return (
    <main className="bg-night-garden relative min-h-screen overflow-hidden">
      ...
      {/* ---- Desktop: landscape crop, fills the entire viewport (cover-fit,
          no letterboxing) ---- */}
      <div
